  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Client Employees</h1>
          <p className="text-muted-foreground text-sm">Manage staff members for your clients</p>
        </div>
      </div>
              ...
              <DialogContent className="max-w-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3 pt-5">
                    <Switch checked={form.app_access} onCheckedChange={(v) => setForm({ ...form, app_access: v })} />
      ...
      {!selectedClientId ? (
        <Card><CardContent className="py-12 text-center text-muted-foreground">
          ...
          Select a client to manage employees
        </CardContent></Card>
      ) : loading ? (
        ...
        <Card>
          <CardHeader><CardTitle className="text-lg">Employees ({filtered.length})</CardTitle></CardHeader>
              ...
              <TableBody>
                {filtered.map((e) => (
                  <TableRow key={e.id}>
                    ...
                    <TableCell>
                      <Badge variant={e.status === "active" ? "default" : e.status === "terminated" ? "destructive" : "secondary"}>
                        {e.status}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge variant={e.app_access ? "default" : "outline"}>{e.app_access ? "Yes" : "No"}</Badge>
                    </TableCell>
                    <TableCell>
