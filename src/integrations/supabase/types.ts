  ...
  public: {
    Tables: {
      ...
      crm_communications: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_communications_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      crm_deals: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_deals_accountant_id_fkey"
          ...
          {
            foreignKeyName: "crm_deals_lawyer_id_fkey"
            columns: ["lawyer_id"]
            isOneToOne: false
            referencedRelation: "crm_partners"
            referencedColumns: ["id"]
      ...
      crm_developers: {
        Row: {
          ...
          id: string
          notes: string | null
          past_project_count: number | null
          phone: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "crm_developers_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      crm_investors: {
        Row: {
          ...
          assigned_to: string | null
          borrowing_capacity_band: string | null
          ...
          custom_fields_json: Json | null
          deposit_readiness: string | null
          email: string | null
          entity_type_notes: string | null
          finance_status: string | null
          full_name: string
          id: string
          ...
          smsf_status: string | null
          source: string | null
          stage_changed_at: string | null
          tags: string[] | null
          timeline_to_invest: string | null
          updated_at: string
        }
        Insert: {
          annual_income_band?: string | null
      ...
      crm_projects: {
        Row: {
          ...
          id: string
          investor_type_fit: string[] | null
          launch_date: string | null
          price_band: string | null
          priority_rating: string | null
          project_name: string
          relationship_owner: string | null
          stage: string | null
          state: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "crm_projects_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      crm_properties: {
        Row: {
          ...
          investor_suitability_tags: string[] | null
      ...
      unmatched_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "unmatched_records_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "unmatched_records_resolved_client_id_fkey"
          ...
          {
            foreignKeyName: "unmatched_records_suggested_client_id_fkey"
    ...
    Views: {
      client_integrity_report: {
        Row: {
          business_id: string | null
          client_status: string | null
          contact_name: string | null
          duplicate_email_count: number | null
          duplicate_phone_count: number | null
          email: string | null
          id: string | null
          invoice_count: number | null
          phone: string | null
          project_count: number | null
          seo_project_count: number | null
        ...
        Insert: {
          ...
          client_status?: string | null
          contact_name?: string | null
          duplicate_email_count?: never
          duplicate_phone_count?: never
          email?: string | null
          id?: string | null
          invoice_count?: never
          phone?: string | null
          project_count?: never
          seo_project_count?: never
          ticket_count?: never
          xero_contact_id?: string | null
        }
        Update: {
